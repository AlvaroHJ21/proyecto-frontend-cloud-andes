// Generado mediante `npx shadcn@latest add dropdown-menu`; conserva los estilos oficiales.
// align posiciona el panel; asChild permite reutilizar Button como disparador accesible.
...
function DropdownMenuContent({
  ...
  // false mantiene el panel en el árbol local cuando el navegador no pinta el Portal.
  portalled?: boolean
}) {
  const content = (
  ...
  // El Portal sigue siendo el comportamiento predeterminado del componente oficial.
